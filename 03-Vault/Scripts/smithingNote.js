module.exports = async (params) => {
  ...
  const folderPath = "04-Forge"; // Cambia esto por la ruta de tu carpeta
  const filePath = `${folderPath}/${noteID}.md`;

  // Ruta del template
  const templatePath = "06-Scrolls/smithing.md"; // Cambia esto por la ruta de tu template
